...
public class DbcHelper {
	 ...
	 * @return
	 */
	public static boolean registerJdbcDataSource(String name,
	 ...
	 */
	public static Connection getConnection(String dataSourceName,
			boolean startTransaction) throws SQLException {
	...
	public static boolean startTransaction(Connection conn) throws SQLException {
		...
		OpenConnStats connStats = dsName != null ? openConnStats.get().get(
				dsName) : null;
	 ...
	 * @since 0.4.0
	 */
	public static boolean commitTransaction(Connection conn)
			throws SQLException {
		if (conn == null) {
			return false;
		}
